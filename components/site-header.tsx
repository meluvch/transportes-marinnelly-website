    ...
    <header className="pointer-events-none fixed inset-x-0 top-0 z-50 flex justify-center px-4">
      <div
        className={`pointer-events-auto mt-3 flex w-full max-w-6xl items-center justify-between rounded-full border px-4 transition-all duration-300 sm:px-6 ${
          scrolled
            ? 'h-14 border-border/70 bg-background/75 shadow-[0_8px_30px_rgba(0,0,0,0.06)] backdrop-blur-xl'
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            className="hidden rounded-full bg-brand px-5 py-2.5 text-sm font-semibold text-brand-foreground transition-transform duration-200 hover:-translate-y-0.5 md:inline-flex"
          >
      ...
      {/* Mobile overlay */}
      {open && (
        <div className="pointer-events-auto fixed inset-0 z-50 flex flex-col bg-background md:hidden">
